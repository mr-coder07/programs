...
class bus_booking:
    ...
    def cover_page(self):
        ...
        Label(root, text="\n\n\n\n\nName: Rushil Sharma", font='Arial 16 bold', fg='blue').pack()
        Label(root, text="\nEnr : 221B313", font='Arial 16 bold', fg='blue').pack()
    ...
    def journey_detail_page(self):
        ...
        Label(root, text="Online Bus Booking System", font='Arial 28 bold', bg='blue violet', fg='red').grid(row=2,
                                                                                                          column=3,
                                                                                                          pady=20,
                                                                                                          columnspan=12)
        Label(root, text='Enter Journey Details', bg='light green', fg='purple', font='Arial 18 bold').grid(row=3,
                                                                                                                column=3,
                                                                                                                columnspan=12,
                                                                                                                pady=20)
        ...
        Button(root, text='Show Bus', bg='pink', fg='black', font='Arial 12 bold',command=show_bus).grid(row=4, column=9, padx=30)
    ...
    def check_booking_page(self):
        ...
        def check_tkt():
            ...
            if len(mobile)==10 and mobile.isdigit():
                ...
                Label(text="booking ref = "+b_ref,font='Arial 12 bold', fg='cyan4').grid(row=7,column=4)
                Label(text="name = " + name, font='Arial 12 bold', fg='cyan4').grid(row=7, column=5)
                Label(text="gender = " + gen, font='Arial 12 bold', fg='cyan4').grid(row=7, column=6)
                Label(text="no of seats = " + str(seat), font='Arial 12 bold', fg='cyan4').grid(row=7, column=7)
                Label(text="age = " + str(age), font='Arial 12 bold', fg='cyan4').grid(row=7, column=8)
                Label(text="booked on = " + book_date, font='Arial 12 bold', fg='cyan4').grid(row=8, column=4)
                Label(text="travel date = " + travel_date, font='Arial 12 bold', fg='cyan4').grid(row=8, column=5)
                Label(text="fare = " + str(fare), font='Arial 12 bold', fg='cyan4').grid(row=8, column=6)
                Label(text="total fare = " + str(fare*seat), font='Arial 12 bold', fg='cyan4').grid(row=8, column=7)




        Label(root, image=bus).grid(row=0, column=0, columnspan=12, padx=80)
        Label(root, text="Online Bus Booking System", font='Arial 28 bold', bg='red', fg='blue4').grid(row=2,
                                                                                                         column=0,
                                                                                                         columnspan=12,
                                                                                                         pady=20)
        Label(root, text="Check Your Booking", font='Arial 22 bold', bg='medium orchid', fg='dark green').grid(row=3,
                                                                                                            column=0,
                                                                                                            pady=20,
                                                                                                            columnspan=12,
                                                                                                            padx=600)
